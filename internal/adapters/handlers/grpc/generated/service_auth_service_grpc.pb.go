...
func (c *authGrpcServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/v1_auth_service.AuthGrpcService/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authGrpcServiceClient) VerifySession(ctx context.Context, in *VerifySessionRequest, opts ...grpc.CallOption) (*VerifySessionResponse, error) {
	out := new(VerifySessionResponse)
	err := c.cc.Invoke(ctx, "/v1_auth_service.AuthGrpcService/VerifySession", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthGrpcServiceServer) VerifySession(context.Context, *VerifySessionRequest) (*VerifySessionResponse, error) {
...
func _AuthGrpcService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1_auth_service.AuthGrpcService/Login",
	}
...
func _AuthGrpcService_VerifySession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifySessionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthGrpcServiceServer).VerifySession(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1_auth_service.AuthGrpcService/VerifySession",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthGrpcServiceServer).VerifySession(ctx, req.(*VerifySessionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthGrpcService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "v1_auth_service.AuthGrpcService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthGrpcService_VerifySession_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "service_auth_service.proto",
}
